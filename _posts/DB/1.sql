...
CREATE TABLE team (
  ...
  division      ENUM('Atlantic', 'Central', 'Southeast', 'Northwest', 'Pacific', 'Southwest', 'Not apply'),
  gm            varchar(50)  DEFAULT 'unknown',  #current general manager
  total_salary  INT,
  PRIMARY KEY (team_id),
  FOREIGN KEY (home_arena) REFERENCES arena (arena_id)
);
#1
INSERT INTO team(team_name, home_arena, division, gm, total_salary) VALUES ("Not registered currently", DEFAULT, "Not apply", "-", 0);
#2
INSERT INTO team(team_name, home_arena, division, gm, total_salary) VALUES ("Retired", DEFAULT, "Not apply", "-", 0);
#3
INSERT INTO team(team_name, home_arena, division, gm, total_salary) VALUES ("LOS ANGELES LAKERS", 2, "Pacific", "Rob Pelinka", 103044807);
#4
INSERT INTO team(team_name, home_arena, division, gm, total_salary) VALUES ("GOLDEN STATE WARRIORS", 3,"Pacific", "Bob Myers", 137593052);
#5
INSERT INTO team(team_name, home_arena, division, gm, total_salary) VALUES ("LA CLIPPERS", 2, "Pacific", "Michael Winger", 119011260);
#6
INSERT INTO team(team_name, home_arena, division, gm, total_salary) VALUES ("HOUSTON ROCKETS", 4, "Southwest", "Daryl Morey", 119606297);
#7
INSERT INTO team(team_name, home_arena, division, gm, total_salary) VALUES ("fake team", 5, "Southwest", DEFAULT, 2);
############################# player entity ##################################
...
("Kobe Bryant", '1978-08-23', 212, 78, 2, 'SG', '1996', "5×champion, 2×FMVP, 1×MVP"),
...
("ME", '1993-11-09', 176, 64, 1, 'Not apply', DEFAULT, DEFAULT);
#################### coach weak entity (multi-attr pk) ##########################
...
#  referees        varchar(250)   NOT NULL,
  ...
  score            varchar(45)    DEFAULT '0:0',   # 'home_team_score:guest_team_score'
  FOREIGN KEY (home_team_id) REFERENCES team (team_id) ,
  FOREIGN KEY (guest_team_id) REFERENCES team (team_id) ,
  PRIMARY KEY (game_id)
);
# Dec 22, 2017 - LAL106 @ GSW113 # https://stats.nba.com/game/0021700479/
INSERT INTO game(date, game_type, home_team_id, guest_team_id, score) VALUES ('2017-12-22', 'regular', 4, 3, '106:113');
# Dec 29, 2017 - LAL106 vs. LAC121 # https://stats.nba.com/game/0021700529/
INSERT INTO game(date, game_type, home_team_id, guest_team_id, score) VALUES ('2017-12-29', 'regular', 3, 5, '121:106');
# Feb 22, 2018 - GSW134 vs. LAC127 #https://stats.nba.com/game/0021700872/
INSERT INTO game(date, game_type, home_team_id, guest_team_id, score) VALUES ('2018-02-22', 'regular', 4, 5, '134:127');
...
(3, 4, 3133, 16, 5, 7, DEFAULT, DEFAULT, 6, 6, 5, 9, 3, 4, 3, 3, 1),
(3, 3, 3708, 44, 14, 19, 8, 11, 8, 8, 1, 5, 10, 4, 2, 0, 4),
(1, 2, 4258, 27, 9, 15, 3, 6, 6, 8, 3, 11, 1, 3, 2, 1, 3);
############################# Result print out ##################################
Show tables;
